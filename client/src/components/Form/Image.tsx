...
export const Image: React.FC = () => {
    ...
    const setShowUrlInput = useStoreActions(
        actions => actions.setUseCustomImage
    );
    ...
    const setCustomImageUrl = useStoreActions(
        actions => actions.setCustomImageUrl
    );
    ...
    return (
        <FormGroup>
            ...
            <Row>{showUrlInput ? renderImageUrl() : renderIcon()}</Row>
            <Row>{renderSize()}</Row>
        </FormGroup>
    );
                ...
                <Label className="form-label">
                    ...
                    <a
                        ...
                        onClick={e => {
                            ...
                            setTimeout(() => {
                                document
                                    .getElementById("image-url-input")
                                    ?.focus();
                            }, 10);
                        }}
                    >
