...
export const Heading: React.FC = () => {
    ...
    const setTitleFontSize = useStoreActions(actions => actions.setTitleFontSize);
    ...
    function renderTitle() {
        ...
        return (
            <Col>
                <Label for={id} className="form-label" value={title}>Title</Label>
                <Input id={id} type="text" onChange={e => setTitle(e.target.value)} />
            </Col>
        );
    }
